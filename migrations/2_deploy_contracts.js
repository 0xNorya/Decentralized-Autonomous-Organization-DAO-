...
module.exports = async function (deployer) {
    ...
    //array of one executor of proposal, one member making a proposal and 5 voters 
    const [executor, proposer, voter1, voter2, voter3, voter4, voter5] = await web3.eth.getAccounts()

    const name = "Project 97"
    const symbol = "P97"
    ...
    //Gives each voter 50 tokens from the executor
    ...
    const votingPeriod = 5 // How many blocks to allow voters to vote
                        ...
                        //Parameters passed into GOvernance smart contract
    ...
    //Transfers ownership of treasury to time lock contract
    ...
    //Grants above roles to the governance Contract
